...
const Popup = ({handleFunction, data,setTutorId,setStudentFirstName,setStudentLastName,setStudentId,setSessionType,setPopup,dataType,err}) => {
    ...
    return (
        <div 
            className="transition-transform ease-linear duration-500 absolute top-0 bg-black bg-opacity-50 w-full h-full"
        >
                <motion.div 
                    ...
                    className='relative m-auto top-1/4 w-1/2 bg-white p-5 border-solid border-2 border-black flex flex-col justify-center items-center gap-1'>
