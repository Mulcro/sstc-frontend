...
const SideBar = () => {
    ...
    <div>
        ...
        <div id="drawer-navigation" className="fixed top-0 left-0 z-40 w-64 h-screen p-4 bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
